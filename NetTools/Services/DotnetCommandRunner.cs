...
public sealed class DotnetCommandRunner(IAnsiConsole console, IProcessRunner processRunner) : IDotnetCommandRunner
{
    ...
    /// <param name="verbose">
    /// If true, enables verbose output for the command execution.
    /// </param>
    private bool Clean(string solutionDirectory, string? solutionOrProjectFile = null, bool verbose = false)
        => RunDotnetCommand("clean", solutionDirectory, solutionOrProjectFile, verbose);
    ...
    /// If true, enables verbose output for the command execution.
    /// </param>
    private bool Restore(string solutionDirectory, string? solutionOrProjectFile = null, bool verbose = false)
        => RunDotnetCommand("restore", solutionDirectory, solutionOrProjectFile, verbose);
    ...
    /// If true, enables verbose output for the command execution.
    /// </param>
    private bool Build(string solutionDirectory, string? solutionOrProjectFile = null, bool verbose = false)
        => RunDotnetCommand("build", solutionDirectory, solutionOrProjectFile, verbose);
    ...
    /// </remarks>
    public bool RunSequentialCommands
    (
